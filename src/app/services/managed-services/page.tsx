...
export const metadata: Metadata = {
  title: 'managed services Service',
  description: 'Specialized Salesforce consulting engagement for managed services with measurable revenue outcomes.'
};
...
export default function Page() {
  return (
    <div className="container-wrap section-padding max-w-4xl">
      ...
      <h1 className="headline-lg mt-4 capitalize">managed services for enterprise revenue teams</h1>
      ...
      <Link href="/book-strategy-call" className="btn-primary mt-8">Discuss managed services strategy</Link>
    </div>
  );
}
